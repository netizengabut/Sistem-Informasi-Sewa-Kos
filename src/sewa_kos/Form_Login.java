...
public class Form_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtuser.setFont(new java.awt.Font("Georgia", 3, 12)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try {
        ...
        String sql="Select * from pemilik where Username='"+txtuser.getText()+"' and password='"+txtpas.getText()+"'";
        ResultSet res = stat.executeQuery(sql);;
        if (res.next()) {
            if(txtuser.getText().equals(res.getString("Username"))&&txtpas.getText().equals(res.getString("password")))
            {  
